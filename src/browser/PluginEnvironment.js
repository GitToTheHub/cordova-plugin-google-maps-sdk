...
module.exports = {
  ...
  'getLicenseInfo': function(onSuccess) {
    // stub
    onSuccess('cordova-plugin-google-maps-sdk for browser does not need to display any open source lincenses. But for iOS, you still need to display the lincense.');
  },
